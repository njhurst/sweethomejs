...
- Spikes:
  - **CheerpJ spike** (2–3 days): run the actual Java app in-browser to (a)
    ...
    app inside CI, (c) sanity-check tricky interactions. _Not the product
    path_, just a test oracle + demo.
